...
func _init(_node_path_string : String, _use_action : String, _inventory_slot_path_string : String, _inventory_progress_bar_path_string : String, _rest_position : Vector3, _foreground_position : Vector3):
